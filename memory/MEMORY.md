...
- [v0.11 features](project_v011_features.md) — OAuth 2.0 + PKCE end-to-end (Google bundled, extensible), Prisma OAuthAccount model, client SDK helpers, 0.10 REFRESH-enum regression fix
